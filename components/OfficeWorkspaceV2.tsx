      ...
      {calendarView === "list" ? <div className="grid gap-4 p-4 sm:p-5 lg:grid-cols-2">
        ...
        <aside ref={resultsRef} className="scroll-mt-[92px] self-stretch border-t border-slate-200 bg-white p-4 sm:p-5 lg:border-l lg:border-t-0 lg:p-0"><div className="h-full lg:p-5">
          ...
          <div className="space-y-3">
            ...
            <button type="button" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="mt-4 w-full rounded-xl bg-[#4285F4] px-4 py-2.5 text-center text-sm font-black text-white shadow-sm transition hover:bg-[#3367D6] focus:outline-none focus:ring-2 focus:ring-[#4285F4]/30 lg:hidden">Back To Calendar</button>
          </div>
          </div>
        </aside>
      </div>}
