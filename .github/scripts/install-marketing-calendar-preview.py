...
# Clean icons that were used only by the old generic hero mock.
text = text.replace('ArrowRight, BadgeCheck, BriefcaseBusiness, CalendarCheck2, Check, Clock3, DollarSign, MapPin, Menu, Search, ShieldCheck, Sparkles, UserCheck, X',
                    'ArrowRight, BriefcaseBusiness, CalendarCheck2, Check, DollarSign, Menu, Search, ShieldCheck, Sparkles, UserCheck, X')
