...
text = path.read_text()
old = '''{selectedInterest?.shifts && <section className="rounded-3xl border-2 border-[#34A853]/40 bg-[#eaf8ee] p-2.5 shadow-sm">
...
new = '''{selectedInterest?.shifts && <section className="rounded-3xl border-2 border-[#EA4335]/55 bg-[#fff1f0] p-2.5 shadow-md ring-1 ring-[#EA4335]/10">
              <div className="mb-2 flex items-center justify-between gap-2 px-1">
...
if old not in text:
    raise SystemExit('Target selected-interest block not found')
