...
begin
  ...
  select email into v_office_email from auth.users where id=v_office.owner_id;
...
grant execute on function public.get_booking_cancellation_context(uuid) to authenticated;
