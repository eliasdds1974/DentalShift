    ...
    <section className="border-b border-[#002757]/10 bg-white">
      <div className="mx-auto max-w-7xl px-4 py-7 sm:px-6 lg:px-8">
        ...
        <div className={`mt-6 grid gap-4 ${portalRole ? "max-w-2xl" : "lg:grid-cols-2"}`}>
          {portalRole !== "professional" && <button type="button" onClick={() => { setEditingListing(null); setPostingMode("office"); setSubmitted(false); setPosted(false); setPublishError(""); }} className="group relative overflow-hidden rounded-2xl border-2 border-[#002757]/30 bg-gradient-to-br from-[#f4f8fc] via-white to-[#f1fbf4] p-5 text-left shadow-md transition hover:-translate-y-1 hover:border-[#002757] hover:shadow-lg"><div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#002757] via-[#01A32E] to-[#002757]" /><div className="flex items-start gap-4"><span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-[#002757] text-white shadow-sm ring-4 ring-[#002757]/5"><Building2 size={24} /></span><div><p className="text-xs font-black uppercase tracking-[0.12em] text-[#002757]">Dental Office</p><h2 className="mt-1 text-xl font-black text-slate-900">Post a Position</h2><p className="mt-2 text-sm leading-6 text-slate-600">Advertise an opening anonymously. Your office name, exact address and contact information stay private.</p><span className="mt-3 inline-flex items-center gap-2 rounded-lg bg-[#eaf8ee] px-3 py-2 text-sm font-black text-[#017f27] transition group-hover:bg-[#01A32E] group-hover:text-white">Create office posting <BriefcaseBusiness size={16} /></span></div></div></button>}
